...
export default function Header() {
  ...
  return (
    <div>
      <div className="px-4 py-2 md:py-4 md:px-8 flex items-center justify-between mx-auto gap-x-3 sm:gap-x-6">
        <p className="sm:text-lg font-mono text-nowrap">
          {month}{" "}
          <span className="text-yellow-500 font-semibold">{currentDay}</span>/
          {daysInMonth}
        </p>
